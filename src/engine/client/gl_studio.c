...
void R_StudioInit( void )
{
	...
	r_studio_sort_textures = Cvar_Get( "r_studio_sort_textures", "1", FCVAR_ARCHIVE, "change draw order for additive meshes" );
	...
	r_elightsys = Cvar_Get("r_elightsys", "1", FCVAR_ARCHIVE, "Vertex lighting system based on elights");
