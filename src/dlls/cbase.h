...
constexpr auto GIB_ALWAYS = 2; // always gib ( Houndeye Shock, Barnacle Bite );
...
constexpr auto BAD_WEAPON = 0x00007FFF;
...
constexpr auto TRACER_FREQ = 4;			// Tracers fire every 4 bullets;
