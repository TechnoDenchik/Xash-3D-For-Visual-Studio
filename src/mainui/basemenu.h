...
// engine constants
constexpr auto GAME_NORMAL = 0;
constexpr auto GAME_SINGLEPLAYER_ONLY = 1;
constexpr auto GAME_MULTIPLAYER_ONLY = 2;

constexpr auto KEY_CONSOLE = 0;
constexpr auto KEY_GAME = 1;
constexpr auto KEY_MENU = 2;

constexpr auto CS_SIZE = 64;	// size of one config string;
constexpr auto CS_TIME = 16;	// size of time string;
...
constexpr auto UI_CURSOR_SIZE = 40;

constexpr auto UI_MAX_MENUDEPTH = 8;
constexpr auto UI_MAX_MENUITEMS = 1000;

constexpr auto UI_PULSE_DIVISOR = 75;
constexpr auto UI_BLINK_TIME = 250;
constexpr auto UI_BLINK_MASK = 499;

constexpr auto UI_SMALL_CHAR_WIDTH = 10;
constexpr auto UI_SMALL_CHAR_HEIGHT = 20;
constexpr auto UI_MED_CHAR_WIDTH = 18;
constexpr auto UI_MED_CHAR_HEIGHT = 26;
constexpr auto UI_BIG_CHAR_WIDTH = 20;
constexpr auto UI_BIG_CHAR_HEIGHT = 40;

constexpr auto UI_MAX_FIELD_LINE = 256;
#define UI_OUTLINE_WIDTH		uiStatic.outlineWidth	// outline thickness

constexpr auto UI_MAXGAMES = 900;	// slots for savegame/demos;
constexpr auto UI_MAX_SERVERS = 64;
constexpr auto UI_MAX_BGMAPS = 32;

constexpr auto MAX_HINT_TEXT = 512;

// menu banners used fiexed rectangle (virtual screenspace at 640x480)
constexpr auto UI_BANNER_POSX = 72;
constexpr auto UI_BANNER_POSY = 72;
constexpr auto UI_BANNER_WIDTH = 736;
constexpr auto UI_BANNER_HEIGHT = 128;

// menu buttons dims
constexpr auto UI_BUTTONS_WIDTH = 240;
constexpr auto UI_BUTTONS_HEIGHT = 40;
constexpr auto UI_BUTTON_CHARWIDTH = 14;	// empirically determined value;

constexpr auto ID_BACKGROUND = 0;	// catch warning on change this;
