...
static void UI_VidOptions_Init( void )
{
	...
	uiVidOptions.done.generic.statusText = "Вернитесь в меню видео";
	...
	uiVidOptions.screenSize.generic.statusText = "Установите размер экрана";
	...
	uiVidOptions.gammaIntensity.generic.statusText = "Установленное значение гаммы (1.8 - 3.0)";
	...
	uiVidOptions.glareReduction.generic.statusText = "Установите уровень уменьшения бликов";
